...
class ModelCommand extends BaseCommand
{
     ...
     * @var string
     */
    protected $signature = 'asap:model
    {--s|skip-composer : Skip running `composer dump` before running this command. This is only to be used in development of the command since it speeds up things. When used to database site it shouldnt be used since classnames are cached and needs to be updated between runs.}
    {--o|overwrite : This will send in --force or --overwrite or corresponding to the commands. This might overwrite work if the site is already built but just needs a few more columns or similar. }
    {--i|ignore=* : Probably the most useful option. This will ignore database tables from all generators. Can be comma separated list or multiple --i options}';
     ...
     * @var string
     */
    protected $description = 'Collection of commands to generate as close to a whole website database as possible based on exiting database structure.';
